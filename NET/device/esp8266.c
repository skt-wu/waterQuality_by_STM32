...
#define ESP8266_WIFI_INFO		"AT+CWJAP=\"Redmi K40\",\"520.13646999278\"\r\n"
...
void ESP8266_Init(void)
{
	...
	printf("AT+CWDHCP\r\n");																			//DHCP自动给内网机器分配IP地址的协议
																																//STA运行DHCPC，使得运行DHCPC的设备具有上网的能力
	while(ESP8266_SendCmd("AT+CWDHCP=1,1\r\n", "OK", 200))				//后面一个1，设置成STA，前面一个1，开启DHCP
		delay_ms(500);
	...
	printf("CIPSTART\r\n");
	while(ESP8266_SendCmd(ESP8266_ONENET_INFO, "CONNECT", 200))		//TCP连接
		delay_ms(500);
